...
export const Heading3Bold: React.FC<Typography> = ({ children, classname }) => {
  const heading1_style = cx(
    ["font-default text-2xl leading-[4rem] font-bold"],
    classname
  );
  return <h3 className={heading1_style}>{children}</h3>;
};
